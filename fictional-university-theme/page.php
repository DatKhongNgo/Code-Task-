...
<div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
        <h1 class="page-banner__title">Aubout Us</h1>
        <div class="page-banner__intro">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Amet velit debitis quas, sapiente voluptatibus accusamus a laborum ex animi minima ab dolorum placeat quidem provident quae. Maxime eveniet illum porro!</p>
        </div>
    </div>
</div>
<div class="container container--narrow page-section">
    ...
    <div class="page-links">
        <h2 class="page-links__title"><a href="<?php echo site_url('/about-us-2') ?>">About Us</a></h2>
        <ul class="min-list">
    ...
    <div class="generic-content">
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsa laboriosam id deserunt fugit ipsam magni reiciendis, maxime ducimus odio, nesciunt suscipit corrupti quae unde. Aliquid quam culpa quisquam blanditiis ad?</p>
